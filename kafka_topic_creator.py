...
if __name__ == '__main__':
    ...
    parser.add_argument('--num_partitions', type=int, default=1, help="kafka bootstrap servers address")
    parser.add_argument('--replication_factor', type=int,default=1, help="kafka bootstrap servers address")
